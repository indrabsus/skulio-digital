                ...
                <table class="table table-stripped">
                  ...
                  @foreach ($data as $d)
                      <tr>
                          ...
                          <td>{{$d->nama_role}}</td>
                          <td>
                              <a href="" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#edit" wire:click='edit({{$d->id_barang}})'>Ubah</i></a>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.live="jenis_barang" class="form-control">
                        <div class="text-danger">
                                @error('jenis_barang')
                                    {{$message}}
                                @enderror
