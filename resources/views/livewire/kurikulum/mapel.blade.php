                ...
                <table class="table table-stripped">
                  ...
                  @foreach ($data as $d)
                      <tr>
                          ...
                          <td>
                              <a href="" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#edit" wire:click='edit({{$d->id_mapel}})'>Ubah</i></a>
                              <a href="" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#k_hapus" wire:click="c_delete({{$d->id_mapel}})">Hapus</a>
                          </td>
                      </tr>
                  @endforeach
                  </tbody>
