                ...
                <table class="table table-stripped">
                  ...
                  @foreach ($data as $d)
                      <tr>
                          ...
                          <td>{{$d->nama_role}}</td>
                          <td>
                              <a href="" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#edit" wire:click='edit({{$d->id_menu}})'>Ubah</i></a>
                              <a href="" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#k_hapus" wire:click="c_delete({{$d->id_menu}})">Hapus</a>
                          </td>
                      </tr>
                  @endforeach
                  </tbody>
