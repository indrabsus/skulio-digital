          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group mb-3">
                    ...
                    <textarea wire:model="pertanyaan" cols="30" rows="10" class="form-control"></textarea>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" wire:model="id_kombel">
                        <option value="">Pilih Opsi</option>
                        @foreach ($kombel as $k)
                            <option value="{{ $k->id_kombel }}">{{$k->pertemuan.'. '.$k->tema}}</option>
                        @endforeach
                    </select>
                    <div class="text-danger">
                        @error('id_kombel')
