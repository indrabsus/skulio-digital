                ...
                <table class="table table-stripped">
                  ...
                  @foreach ($data as $d)
                      <tr>
                          ...
                          <td>
                            @php
                                $hitung = App\Models\DataPkl::where('id_siswa', $d->id_siswa)->count();
                            @endphp
                            @if ($hitung > 0)
                            <button class="btn btn-success btn-xs" disabled>Sudah Isi</button>
                            @else
                            <a href="" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#pkl" wire:click='pkl("{{$d->id_siswa}}")'>Isi Data</a>
                            @endif
