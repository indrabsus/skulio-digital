                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-success btn-xs" data-bs-toggle="modal"
                                        data-bs-target="#edit" wire:click='edit("{{ $d->id_tempat }}")'><i
                                            class="fa-solid fa-edit"></i></i></a>
                                    <a href="" class="btn btn-danger btn-xs" data-bs-toggle="modal"
                                        data-bs-target="#k_hapus" wire:click="c_delete('{{ $d->id_tempat }}')"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" wire:model.live="tempat_pkl" class="form-control">
