<div>
               ...
               <div class="table-responsive">
                <table class="table table-stripped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{ $d->link }}" target="_blank">{{$d->nama_rapat}}</a>
                    </td>
                    <td>
                        {{date('l, d F Y', strtotime($d->tanggal_rapat))}}
                    </td>
                    <td>
                        <a href="" class="btn btn-primary btn-xs" data-bs-toggle="modal" data-bs-target="#notulen" wire:click='notulen2("{{$d->id_rapat}}")'>Notulen</a>
                        <a href="" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#edit" wire:click='edit("{{$d->id_rapat}}")'><i class="fa-solid fa-edit"></i></a>
                        <a href="" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#k_hapus" wire:click="c_delete('{{$d->id_rapat}}')"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" wire:model.live="nama_rapat" class="form-control">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="date" wire:model.live="tanggal_rapat" class="form-control">
                    <div class="text-danger">
                        @error('tanggal_rapat')
                            {{$message}}
                        @enderror
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea name="" wire:model.live="notulen" id="" cols="30" rows="10" class="form-control"></textarea>
                    <div class="text-danger">
                        @error('notulen')
                            {{$message}}
                        @enderror
    ...
    <div class="modal fade" id="notulen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
